...
const FAQS = [
    {
        ...
        answer: "Aqualog helps coastal teams in Monastir and Mahdia track pollution pressure by turning seawater samples and satellite views into clear livability scores and algae alerts.",
    },
    {
    ...
    },
    {
        ...
        answer: "It is designed for researchers, environmental agencies, and local stakeholders who monitor Tunisian central coast waters and need faster, comparable insight across sites and time.",
    },
    {
        question: "What makes our solution different?",
        answer: "Instead of generic dashboards, Aqualog combines two focused AI tools—seawater livability scoring and satellite algae classification—with explainable outputs tailored to Monastir and Mahdia coastal contexts.",
    }
];
