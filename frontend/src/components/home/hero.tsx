          ...
          <div className="flex flex-col items-center lg:items-start justify-center">
            ...
            <Container delay={0.2}>
              <p className="text-base md:text-lg font-normal text-center lg:text-left text-balance text-muted-foreground max-w-3xl mx-auto lg:mx-0 mt-4">
                Connect your data, protect your coast. Aqualog flags algae risks and assesses seawater quality to trigger early warnings.
              </p>
            </Container>
