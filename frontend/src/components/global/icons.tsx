...
const Icons = {
    ...
    logo: (props: LucideProps) => (
        <svg {...props} width="152" height="33" viewBox="0 0 152 33" fill="none" xmlns="http://www.w3.org/2000/svg" >
            {/* Icon */}
            ...
            <text x="36" y="25" fill="white" fontSize="21" fontWeight="500" fontFamily="Arial, Helvetica, " >
                Aqualog
            </text>
